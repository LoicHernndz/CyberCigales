...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showFeedback(S_message, B_success, B_complete) {
        ...
        if (B_complete) {
            ...
            S_highlighted = S_highlighted.replace('@ALEX_PHOTO', '<a href="/instagram/user/avsl_ydbjb" target="_blank" class="highlight-name" style="text-decoration:underline;cursor:pointer;">@ALEX_PHOTO</a>');
