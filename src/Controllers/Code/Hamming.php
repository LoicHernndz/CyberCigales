...
class Hamming extends AbstractController
{
    ...
    private const key = "MON NOM EST ALEXANDRE SCHMIDT (@ALEX_PHOTO). TOUT EST CHIFFRÉ. J'AI UNE CLE A ENVOYER MAIS JE DOIS PAYER POUR LA DECRYPTER : WDSKAVZSJNBCS";
    private const noise = "AFO QMP EIJ YZDKSLCFR AIZDKSQ (@APFD_PKSDF). ZEFJ ZEI ADZOKFE. A'AI JIE VBC X FQMLKFP EIOS BA MWLK KFEZH ASXN LP ADZSDOICO : FEOIKSDQPHEAZ";
